  ...
  return (
    <CustomInput
      ...
      inputProps={{
        ...
        placeholder: `Busca ${count} campos...`,
      }}
    />
  );
}
    ...
    <>
      <div className="ReactTable -striped -highlight">
        ...
        <table ref={tableRef} >
                ...
                {headerGroup.headers.map((column, key) => (
                  <th
                    ...
                    className={classnames("rt-th rt-resizable-header", {
                      "-cursor-pointer": headerGroup.headers.length - 0 !== key,
                  ...
                  >
                    ...
                    <div>
                      {headerGroup.headers.length -0 === key
                        ? null
                        : column.canFilter
          ...
          <tbody {...getTableBodyProps()} className="rt-tbody" ref={tableRef}>
            {page.map((row, i) => {
              prepareRow(row);
              return (
                <tr
